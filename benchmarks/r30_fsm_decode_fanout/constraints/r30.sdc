# r30 -- fsm_decode_fanout: ASIC constraints (?)

if {![info exists ::CLK_PERIOD]} { set ::CLK_PERIOD 1.0 }
...
set_input_delay  [expr {0.15 * $::CLK_PERIOD}] -clock clk [get_ports {rst_n instr_valid instr_op din}]
set_output_delay [expr {0.15 * $::CLK_PERIOD}] -clock clk [get_ports {dout}]

set_driving_cell -lib_cell BUF_X4 -pin Z \
    [get_ports {rst_n instr_valid instr_op din}]
